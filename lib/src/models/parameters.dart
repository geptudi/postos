const Map<String, List<String>> postos = {
  ...
  'Eurípedes Barsanulfo': <String>[
    ...
    'Thiago - 9 9267 2502',
    'As Cestas para este posto, devem ser entregues no domingo do dia 22/12 das 8:00 as 12:00, ou em uma data previamente combinada com os coordenadores do respectivo posto.',     
  ],
  'Mãe Zeferina': <String>[
